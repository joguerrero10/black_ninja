...
let inicio = {
  ...
  salirInstructivo: function () {
    document
      .querySelector("#instruccionesTouch")
      .parentNode.removeChild(document.querySelector("#instruccionesTouch"));
  },
    ...
    if (window.matchMedia("(min-width:1025px)").matches) {
      ...
      function statusChangeCallback(response) {
        if (response.status === "connected") {
          ...
          document.querySelector("#ingresoFacebook").innerHTML +=
            '<div style="color:white; text-align:center">¡Vuelve a intentarlo!</div>';
        }
      }
      ...
      function testAPI() {
        FB.api(
          "/me?fields=id,name,first_name,email,picture",
          function (response) {
  ...
  inicioNiveles: function (nivel) {
    ...
    datos.colisionesBalasEnemigos.src =
      "views/img/utileria/colisionesBalasEnemigos.png";
    ...
    function precarga(e) {
      ...
      document.querySelector("#carga progress").value = Math.ceil(
