  ...
  tiempo: function () {
    ...
    for (var i = 0; i < datos.plataforma.length; i++) {
      function colisionesPlataforma() {
        ...
        if (
          datos.jugador_y >
          datos.plataforma[i].y + datos.plataforma[i].alto
        ) {
          return false;
        }
        ...
        if (
          datos.jugador_x >
          datos.plataforma[i].x + datos.plataforma[i].ancho
        ) {
          return false;
        }
      ...
      if (
        colisionesPlataforma() &&
        datos.jugador_y + datos.jugador_alto <
          datos.plataforma[i].y + datos.gravedad
      ) {
        datos.gravedad = 0;
      ...
      if (datos.desplazamientoEscenario <= datos.limiteEscenario) {
        ...
        if (
          colisionesPlataforma() &&
          datos.jugador_x + datos.jugador_ancho <
            datos.plataforma[i].x + datos.movimientoJugador
        ) {
          datos.movimientoJugador = 0;
        ...
        if (
          colisionesPlataforma() &&
          datos.jugador_x + datos.movimiento >
            datos.plataforma[i].x + datos.plataforma[i].ancho
        ) {
          datos.movimiento = 0;
          datos.jugador_x = datos.plataforma[i].x + datos.plataforma[i].ancho;
    ...
    if (datos.reset) {
      ...
      if (datos.nivel == 1) {
        ...
        xhr_plataforma.open(
          "GET",
          "views/js/json/plataformasNivel1.json",
          true
        );
      }
      ...
      if (datos.nivel == 2) {
        ...
        xhr_plataforma.open(
          "GET",
          "views/js/json/plataformasNivel2.json",
          true
        );
      }
      ...
      if (datos.nivel == 3) {
        ...
        xhr_plataforma.open(
          "GET",
          "views/js/json/plataformasNivel3.json",
          true
        );
      }
