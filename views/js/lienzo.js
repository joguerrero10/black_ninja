...
let lienzo = {
  canvas: function () {
    ...
    ctx.drawImage(
      datos.plano3,
      datos.desplazamientoEscenario / 5,
      0,
    ...
    ctx.drawImage(
      datos.plano3,
      datos.desplazamientoEscenario / 5 + 1000,
      0,
      datos.plano3.naturalWidth,
      datos.plano3.naturalHeight
    );
    ...
    ctx.drawImage(
      datos.plano2,
      datos.desplazamientoEscenario / 3.5,
      0,
    ...
    ctx.drawImage(
      datos.plano2,
      datos.desplazamientoEscenario / 3.5 + 1000,
      0,
      datos.plano2.naturalWidth,
      datos.plano2.naturalHeight
    );
    ...
    ctx.drawImage(
      datos.plano1,
      datos.desplazamientoEscenario / 2,
      0,
    ...
    ctx.drawImage(
      datos.plano1,
      datos.desplazamientoEscenario / 2 + 1000,
      0,
      datos.plano1.naturalWidth,
      datos.plano1.naturalHeight
    );
    ...
    for (let i = 0; i < datos.bloquesDetalles.length; i++) {
      ctx.drawImage(
        datos.detalles,
        datos.bloquesDetalles[i].x + datos.desplazamientoEscenario,
    ...
    for (let i = 0; i < datos.bloques.length; i++) {
      ctx.drawImage(
        ...
        datos.bloques[i].x + datos.desplazamientoEscenario,
        datos.bloques[i].y,
    ...
    ctx.drawImage(
      datos.plano0,
      datos.desplazamientoEscenario / 1.5,
      0,
    ...
    ctx.drawImage(
      datos.plano0,
      datos.desplazamientoEscenario / 1.5 + 1000,
      0,
      datos.plano0.naturalWidth,
      datos.plano0.naturalHeight
    );
